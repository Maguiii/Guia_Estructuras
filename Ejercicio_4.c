...
int main(){
	...
	for (i=0 ; i<12 ; i++)  // Se agrega una parte mas para comparar los montos de los meses y detectar si hubo mas de un mes con el mayor monto.
	{
		if (monto_mes[i] == monto_mes[mejor])
		{
			printf ("y el %d ",++i);
		}
	}
